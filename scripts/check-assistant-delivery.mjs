...
const checks = [
  ...
  [api.includes('agent-dialogue.jsonl') && api.includes('readAgentDialogueState') && api.includes('agentDialogueRecordFromVoiceMessage'), "Direct voice/Pi coordination is persisted as shared agent-dialogue JSONL"],
